...
:deep(.search-wrap .el-input__wrapper.is-focus .el-input__prefix .el-icon) {
...
.nav-item.active {
  ...
  color: var(--accent);
  font-weight: 600;
  box-shadow: 0 1px 4px rgba(var(--accent-rgb), 0.06);
}
...
/* ===== 分类列表 ===== */
.category-list { flex: 1; overflow-y: auto; padding: 0 8px; }
